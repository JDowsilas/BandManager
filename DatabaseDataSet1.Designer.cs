...
namespace BandManagerApp {
    ...
    public partial class DatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class MembersDataTable : global::System.Data.TypedTableBase<MembersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MembersRow AddMembersRow(string Name, string Role) {
        ...
        public partial class MembersRow : global::System.Data.DataRow {
            ...
            public string Role {
                get {
                    try {
                        return ((string)(this[this.tableMembers.RoleColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableMembers.RoleColumn] = value;
                }
            }
            ...
            public bool IsRoleNull() {
                return this.IsNull(this.tableMembers.RoleColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetRoleNull() {
                this[this.tableMembers.RoleColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace BandManagerApp.DatabaseDataSet1TableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Members] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 A" +
                "ND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Role = 1 AND [Rol" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Members] ([Id], [Name], [Role]) VALUES (@Id, @Name, @Role);\r\nS" +
                "ELECT Id, Name, Role FROM Members WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Members] SET [Id] = @Id, [Name] = @Name, [Role] = @Role WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)));
SELECT Id, Name, Role FROM Members WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BandManagerApp.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Role FROM dbo.Members";
        ...
        public virtual int Fill(DatabaseDataSet1.MembersDataTable dataTable) {
        ...
        public virtual DatabaseDataSet1.MembersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet1.MembersDataTable dataTable = new DatabaseDataSet1.MembersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet1.MembersDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string Name, string Role) {
        ...
        public virtual int Update(int Id, string Name, string Role, int Original_Id, string Original_Name, string Original_Role) {
        ...
        public virtual int Update(string Name, string Role, int Original_Id, string Original_Name, string Original_Role) {
            return this.Update(Original_Id, Name, Role, Original_Id, Original_Name, Original_Role);
        }
    }
